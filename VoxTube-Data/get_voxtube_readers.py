...
def filter_german_speakers():
    with open("../data/VoxTube-Speakers.txt", "r") as f:
        lines = f.readlines()
        ...
        with open("../data/VoxTube-Speakers-German.txt", "x") as f:
            f.writelines(filtered_lines)

def filter_speakers_id():
    with open("../data/VoxTube-Speakers-German.txt", "r") as f:
        lines = f.readlines()
    ...
    with open("../data/VoxTube-Speakers-German.txt", "w") as f:
        f.writelines(filtered_lines)
