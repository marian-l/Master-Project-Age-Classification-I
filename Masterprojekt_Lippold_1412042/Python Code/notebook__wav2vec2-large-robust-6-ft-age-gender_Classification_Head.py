# EXPERIMENTAL WITH CLASSIFICATION HEAD
import json
import torchaudio
import torch
...
class DataCollatorSequenceWithPadding:
    ...
    def __call__(self, features: List[Dict[str, Union[List[int], torch.Tensor]]]) -> Dict[str, torch.Tensor]:
        ...
        # labels = torch.tensor([{'labels': feature['labels']} for feature in features], dtype=torch.long)
        ...
        batch['labels'] = labels  # liegen im Collator vor und werden zurückgegeben
        # print(batch)
...
training_args = TrainingArguments(
    ...
    push_to_hub=True,
    hub_model_id="mlmarian/wav2vec2-age-gender",
...
trainer.push_to_hub("mlmarian/wav2vec2-large-robust-6-ft-age-gender")
trainer.save_model("mlmarian/wav2vec2-large-robust-6-ft-age-gender")
